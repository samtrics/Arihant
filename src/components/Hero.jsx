    ...
    <section className="relative bg-background overflow-hidden min-h-[640px] flex items-center">
      ...
      <div className="w-full px-margin-mobile md:px-margin-desktop grid grid-cols-12 items-center gap-gutter py-stack-xl">
        ...
        <div className="col-span-12 lg:col-span-6 relative h-full flex justify-center lg:justify-end mt-12 lg:mt-0">
          ...
          <div className="relative z-10 flex -space-x-6 md:space-x-4 items-end justify-center w-full px-2 md:px-0">
            <div className="z-10 bg-surface-container-lowest p-2 md:p-4 rounded-xl border border-outline-variant shadow-sm -rotate-12 md:-rotate-6 transform hover:rotate-0 transition-all duration-500">
              <img
                className="w-28 h-40 md:w-48 md:h-64 object-cover rounded-lg shadow-inner"
              ...
              />
              <p className="font-label-md mt-2 md:mt-3 text-center text-xs md:text-base">Daliya</p>
            </div>
            <div className="z-30 bg-surface-container-lowest p-2 md:p-4 rounded-xl border border-outline-variant shadow-md scale-110 hover:-translate-y-4 transition-all duration-500">
              <img
                className="w-36 h-48 md:w-56 md:h-72 object-cover rounded-lg shadow-inner"
              ...
              />
              <p className="font-label-md mt-2 md:mt-3 text-center text-primary font-bold text-xs md:text-base">Chakki Atta</p>
            </div>
            <div className="z-20 bg-surface-container-lowest p-2 md:p-4 rounded-xl border border-outline-variant shadow-sm rotate-12 md:rotate-6 transform hover:rotate-0 transition-all duration-500">
              <img
                className="w-28 h-40 md:w-48 md:h-64 object-cover rounded-lg shadow-inner"
              ...
              />
              <p className="font-label-md mt-2 md:mt-3 text-center text-xs md:text-base">Besan</p>
            </div>
          </div>
        </div>
      </div>
