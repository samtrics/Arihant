    ...
    <section className="relative bg-background overflow-hidden min-h-[640px] flex items-center">
      ...
      <div className="w-full px-margin-mobile md:px-margin-desktop grid grid-cols-12 items-center gap-gutter py-stack-xl">
        ...
        <div className="col-span-12 lg:col-span-6 relative h-full flex justify-center lg:justify-end mt-12 lg:mt-0">
          ...
          <div className="relative z-10 flex gap-2 md:gap-4 items-end justify-center w-full max-w-[100vw] overflow-hidden px-4 md:px-0">
            <div className="bg-surface-container-lowest p-2 md:p-4 rounded-xl border border-outline-variant shadow-sm -rotate-6 transform hover:rotate-0 transition-all duration-500">
              <img
                className="w-24 h-32 sm:w-32 sm:h-40 md:w-48 md:h-64 object-cover rounded-lg shadow-inner"
              ...
              />
              <p className="font-label-md mt-2 md:mt-3 text-center text-[10px] md:text-sm">Daliya</p>
            </div>
            <div className="bg-surface-container-lowest p-2 md:p-4 rounded-xl border border-outline-variant shadow-md scale-110 z-20 hover:-translate-y-2 md:hover:-translate-y-4 transition-all duration-500">
              <img
                className="w-28 h-40 sm:w-36 sm:h-48 md:w-56 md:h-72 object-cover rounded-lg shadow-inner"
              ...
              />
              <p className="font-label-md mt-2 md:mt-3 text-center text-primary font-bold text-[10px] md:text-sm">Chakki Atta</p>
            </div>
            <div className="bg-surface-container-lowest p-2 md:p-4 rounded-xl border border-outline-variant shadow-sm rotate-6 transform hover:rotate-0 transition-all duration-500">
              <img
                className="w-24 h-32 sm:w-32 sm:h-40 md:w-48 md:h-64 object-cover rounded-lg shadow-inner"
              ...
              />
              <p className="font-label-md mt-2 md:mt-3 text-center text-[10px] md:text-sm">Besan</p>
            </div>
          </div>
        </div>
      </div>
