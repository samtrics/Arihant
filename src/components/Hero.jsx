      ...
      <div className="w-full px-margin-mobile md:px-margin-desktop grid grid-cols-12 items-center gap-gutter py-stack-xl">
        ...
        <div className="col-span-12 lg:col-span-6 relative h-full flex justify-center lg:justify-end mt-12 lg:mt-0">
          ...
          <div className="relative z-10 flex gap-4 items-end">
            <div className="bg-surface-container-lowest p-4 rounded-xl border border-outline-variant shadow-sm -rotate-6 transform hover:rotate-0 transition-all duration-500">
              <img
                className="w-48 h-64 object-cover rounded-lg shadow-inner"
              ...
              />
              <p className="font-label-md mt-3 text-center">Daliya</p>
            </div>
            <div className="bg-surface-container-lowest p-4 rounded-xl border border-outline-variant shadow-md scale-110 z-20 hover:-translate-y-4 transition-all duration-500">
              <img
                className="w-56 h-72 object-cover rounded-lg shadow-inner"
              ...
              />
              <p className="font-label-md mt-3 text-center text-primary font-bold">Chakki Atta</p>
            </div>
            <div className="bg-surface-container-lowest p-4 rounded-xl border border-outline-variant shadow-sm rotate-6 transform hover:rotate-0 transition-all duration-500">
              <img
                className="w-48 h-64 object-cover rounded-lg shadow-inner"
              ...
              />
              <p className="font-label-md mt-3 text-center">Besan</p>
            </div>
          </div>
        </div>
      </div>
