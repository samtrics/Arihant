  ...
  return (
    <section className="relative bg-background overflow-hidden min-h-[640px] flex items-center">
      ...
      <div className="w-full px-margin-mobile md:px-margin-desktop grid grid-cols-12 items-center gap-gutter py-stack-xl">
        ...
        <div className="col-span-12 lg:col-span-6 relative h-full flex justify-start lg:justify-end mt-12 lg:mt-0 w-full pr-4 md:pr-0">
          ...
          <div className="relative z-10 flex justify-between md:gap-0 md:-space-x-6 lg:space-x-4 w-full md:w-auto items-end md:justify-center">
            <div className="w-[31%] md:w-48 z-10 bg-surface-container-lowest p-1.5 md:p-4 rounded-xl border border-outline-variant shadow-sm md:-rotate-6 transform hover:rotate-0 transition-all duration-500">
              <img
            ...
            <div className="w-[35%] md:w-56 z-30 bg-surface-container-lowest p-1.5 md:p-4 rounded-xl border border-outline-variant shadow-md scale-105 md:scale-110 hover:-translate-y-4 transition-all duration-500">
              <img
            ...
            <div className="w-[31%] md:w-48 z-20 bg-surface-container-lowest p-1.5 md:p-4 rounded-xl border border-outline-variant shadow-sm md:rotate-6 transform hover:rotate-0 transition-all duration-500">
              <img
                className="w-full aspect-[3/4] md:h-64 object-cover rounded-lg shadow-inner"
